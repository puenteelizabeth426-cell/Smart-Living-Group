    ...
    <main>
      ...
      <section id="catalog" className="catalog section">
        <div className="catalogCard">
          ...
          <p>Browse our full lineup of outdoor audio, landscape lighting, outdoor TVs and motorized shade solutions in one place.</p>
          <a className="button primary" href="/catalog.pdf" target="_blank" rel="noopener noreferrer">Open Catalog <ArrowRight size={18} /></a>
        </div>
      </section>
